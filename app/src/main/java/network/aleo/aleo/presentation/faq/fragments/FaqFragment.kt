package network.aleo.aleo.presentation.faq.fragments
...
import network.aleo.aleo.databinding.FragmentFaqBinding
import network.aleo.aleo.presentation.faq.model.FaqEntity
import network.aleo.aleo.presentation.faq.recycler.FaqRecyclerViewAdapter
import java.util.*
...
class FaqFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return FragmentFaqBinding.inflate(layoutInflater).apply { binding = this }.root
    }
    ...
    private fun buildRecyclerView() {
        ...
        faqEntityList.add(
            FaqEntity(getString(R.string.question27),
